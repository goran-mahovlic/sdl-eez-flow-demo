...
enum StylesEnum {
    ...
    STYLE_ID_TEXT_INPUT = 34,
    STYLE_ID_DEFAULT_XXL = 35,
    STYLE_ID_TEXT_BUTTON = 36,
    STYLE_ID_TEXT_BUTTON_DISABLED = 37,
    STYLE_ID_BUTTON_ICON = 38,
    STYLE_ID_TEXT_BUTTON_ICON = 39,
    STYLE_ID_TEXT_BUTTON_ICON_DISABLED = 40,
...
extern const uint8_t assets[64027];
